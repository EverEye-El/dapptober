...
export function ComingSoonModal({ isOpen, onClose, feature, position = "right" }: ComingSoonModalProps) {
  ...
  const containerClasses =
    position === "left"
      ? "fixed inset-0 z-[9999] flex items-center justify-start p-4 md:p-6 animate-in fade-in duration-200"
      : "fixed inset-0 z-[9999] flex items-center justify-end p-4 md:p-6 animate-in fade-in duration-200"

  const slideAnimation =
    position === "left" ? "animate-in slide-in-from-left duration-200" : "animate-in slide-in-from-right duration-200"
  ...
  return createPortal(
    <div className={containerClasses}>
      ...
      <div className={`relative w-full max-w-md ${slideAnimation}`}>
